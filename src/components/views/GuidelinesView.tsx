...
import { BaseView } from '@/components/layouts'
...
export function GuidelinesView() {
  ...
  return (
    <BaseView 
      title="Decoupled Mastery Learning System"
      subtitle="A structured approach to mastering complex material: build logic in English first, then encode it into Russian as a separate language layer."
      density={density}
      maxWidth="7xl"
      actions={
        <Badge 
    ...
    >
      <div className={density === 'compact' ? 'guideline-shell-compact' : 'guideline-shell'}>
